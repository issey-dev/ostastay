-- AlterTable
ALTER TABLE "EnterpriseSettings" ADD COLUMN "cityLedgerPaymentMethodId" TEXT;
ALTER TABLE "EnterpriseSettings" ADD COLUMN "defaultAccommodationChargeCodeId" TEXT;
...
INSERT INTO "new_RatePlan" ("code", "derivedAdjustmentType", "derivedAdjustmentValue", "description", "id", "isLocked", "isNegotiated", "name", "parentRatePlanId", "priority", "propertyId") SELECT "code", "derivedAdjustmentType", "derivedAdjustmentValue", "description", "id", "isLocked", "isNegotiated", "name", "parentRatePlanId", "priority", "propertyId" FROM "RatePlan";
DROP TABLE "RatePlan";
