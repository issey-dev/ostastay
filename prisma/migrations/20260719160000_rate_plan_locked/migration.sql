...
INSERT INTO "new_RatePlan" ("code", "derivedAdjustmentType", "derivedAdjustmentValue", "description", "id", "isNegotiated", "name", "parentRatePlanId", "priority", "propertyId") SELECT "code", "derivedAdjustmentType", "derivedAdjustmentValue", "description", "id", "isNegotiated", "name", "parentRatePlanId", "priority", "propertyId" FROM "RatePlan";
DROP TABLE "RatePlan";
