...
CREATE TABLE "new_FolioLineItem" (
    ...
    CONSTRAINT "FolioLineItem_generatedFromLineItemId_fkey" FOREIGN KEY ("generatedFromLineItemId") REFERENCES "FolioLineItem" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_FolioLineItem" ("amount", "chargeCodeId", "createdAt", "date", "description", "folioId", "id", "isVoid", "outletCheckId", "outletId", "reference", "roomAssignmentId", "serviceChargeAmount", "shiftId", "taxAmount") SELECT "amount", "chargeCodeId", "createdAt", "date", "description", "folioId", "id", "isVoid", "outletCheckId", "outletId", "reference", "roomAssignmentId", "serviceChargeAmount", "shiftId", "taxAmount" FROM "FolioLineItem";
