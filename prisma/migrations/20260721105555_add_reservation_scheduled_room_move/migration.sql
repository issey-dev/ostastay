...
INSERT INTO "new_Reservation" ("adults", "checkInDate", "checkOutDate", "children", "confirmationNo", "createdAt", "groupBlockId", "id", "infants", "mealPlan", "primaryGuestId", "propertyId", "remarks", "status", "travelAgentId", "updatedAt") SELECT "adults", "checkInDate", "checkOutDate", "children", "confirmationNo", "createdAt", "groupBlockId", "id", "infants", "mealPlan", "primaryGuestId", "propertyId", "remarks", "status", "travelAgentId", "updatedAt" FROM "Reservation";
