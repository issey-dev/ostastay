...
INSERT INTO "new_EnterpriseSettings" ("cashierDefaultFloat", "cityLedgerPaymentMethodId", "commissionChargeCodeId", "confirmationLetterMessage", "defaultAccommodationChargeCodeId", "defaultGreenTaxChargeCodeId", "enterpriseId", "exchangeFromCurrency", "exchangeToCurrency", "greenTaxAdultAmount", "greenTaxChildAmount", "greenTaxEnabled", "greenTaxExemptAge", "id", "invoiceAddress", "invoiceBrandColor", "invoiceBrandName", "invoiceEmail", "invoiceFontFamily", "invoiceFooterText", "invoiceHeaderText", "invoiceLogoUrl", "invoicePaymentAccountName", "invoicePaymentAccountNumber", "invoicePaymentBankInfo", "invoicePaymentIban", "invoicePaymentTerms", "invoicePhone", "invoiceTaxId", "receiptFooterText", "receiptTerms", "registrationCardEnabled", "registrationCardMessage", "registrationCardTerms", "resConfirmLength", "resConfirmPrefix", "serviceChargeEnabled", "serviceChargeRate", "sftpHost", "sftpPassword", "sftpPort", "sftpRemotePath", "sftpUsername", "smtpFromAddress", "smtpHost", "smtpPassword", "smtpPort", "smtpUseTls", "smtpUsername", "statementFooterText", "statementTerms", "systemDate", "tgstEnabled", "tgstRate", "updatedAt") SELECT "cashierDefaultFloat", "cityLedgerPaymentMethodId", "commissionChargeCodeId", "confirmationLetterMessage", "defaultAccommodationChargeCodeId", "defaultGreenTaxChargeCodeId", "enterpriseId", "exchangeFromCurrency", "exchangeToCurrency", "greenTaxAdultAmount", "greenTaxChildAmount", "greenTaxEnabled", "greenTaxExemptAge", "id", "invoiceAddress", "invoiceBrandColor", "invoiceBrandName", "invoiceEmail", "invoiceFontFamily", "invoiceFooterText", "invoiceHeaderText", "invoiceLogoUrl", "invoicePaymentAccountName", "invoicePaymentAccountNumber", "invoicePaymentBankInfo", "invoicePaymentIban", "invoicePaymentTerms", "invoicePhone", "invoiceTaxId", "receiptFooterText", "receiptTerms", "registrationCardEnabled", "registrationCardMessage", "registrationCardTerms", "resConfirmLength", "resConfirmPrefix", "serviceChargeEnabled", "serviceChargeRate", "sftpHost", "sftpPassword", "sftpPort", "sftpRemotePath", "sftpUsername", "smtpFromAddress", "smtpHost", "smtpPassword", "smtpPort", "smtpUseTls", "smtpUsername", "statementFooterText", "statementTerms", "systemDate", "tgstEnabled", "tgstRate", "updatedAt" FROM "EnterpriseSettings";
