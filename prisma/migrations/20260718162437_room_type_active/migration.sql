...
INSERT INTO "new_RoomType" ("basePrice", "bedType", "code", "description", "housekeepingEnabled", "id", "isPseudo", "maxOccupancy", "name", "propertyId", "view") SELECT "basePrice", "bedType", "code", "description", "housekeepingEnabled", "id", "isPseudo", "maxOccupancy", "name", "propertyId", "view" FROM "RoomType";
DROP TABLE "RoomType";
