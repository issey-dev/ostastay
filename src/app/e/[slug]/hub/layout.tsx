...
export default async function HubLayout({
  ...
  return (
    <SidebarProvider>
      ...
      <main id="main-content" tabIndex={-1} className="w-full bg-background min-h-screen max-md:min-h-dvh flex flex-col overflow-x-hidden max-md:overflow-x-clip outline-none">
