...
export default function Overview() {
  return (
    <>
      ...
      <Cards
        items={[
          { href: "/docs/api/getting-started", title: "Getting started →", body: "Get a key and make your first calls." },
          { href: "/docs/api/errors", title: "Error codes →", body: "Every code the API answers with." },
        ]}
      />
      <Pager href="/docs/api" />
    </>
