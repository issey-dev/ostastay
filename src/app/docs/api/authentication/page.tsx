  ...
  return (
    <>
      ...
      <ul>
        ...
        <li><strong>Errors</strong> are JSON with a stable <code>code</code> to switch on, a human <code>error</code>, and, for validation, <code>details</code> keyed by field. See <a href="/docs/api/errors">Error codes</a>.</li>
      </ul>
      ...
      <Pager href="/docs/api/authentication" />
    </>
  )
}
