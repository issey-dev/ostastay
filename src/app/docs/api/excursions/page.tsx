...
`}
      ...
      <ul>
        ...
        <li>
          ...
          until the desk closes the day. See <a href="/docs/api/authentication#conventions">Conventions</a>.
        </li>
      </ul>
...
`}
      ...
      <p>
        ...
        no-show, the lookup shows it and — if you registered one — a <a href="/docs/api/webhooks">webhook</a> tells you.
      </p>
      <Pager href="/docs/api/excursions" />
    </>
  )
}
