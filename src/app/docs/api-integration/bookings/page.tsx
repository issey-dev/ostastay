...
`}
      ...
      />
      <p>Room bookings are looked up with <code>GET /bookings/&#123;confirmationNo&#125;</code> (see <a href="/docs/api-integration/rooms">Rooms</a>) and are cancelled through the property.</p>
      <Pager href="/docs/api-integration/bookings" />
    </>
  )
}
