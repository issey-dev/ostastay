...
export const SHOTS: Shot[] = [
  ...
  { name: "prop-charge-codes-new", path: lodge("cashiering"), maxHeight: 1000, ...card("Charge Codes") },
  { name: "prop-charge-code-dialog", path: resort("cashiering"), dialog: true, before: ({ page }) => click(page, "Add Charge Code") },
  { name: "prop-posting-defaults", path: resort("cashiering"), ...card("Posting Defaults") },
